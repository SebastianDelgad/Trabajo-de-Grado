...
def peor_promedio_calificacion(notas, diccionario):
    ...
    muy_positivo_sort = sorted(muy_positivo.items(), key=operator.itemgetter(1), reverse=True)
    ...
    positivo_ordenado = {}
    positivo_sort = sorted(positivo.items(), key=operator.itemgetter(1), reverse=True)
    ...
    neutral_ordenado = {}
    neutral_sort = sorted(neutral.items(), key=operator.itemgetter(1), reverse=True)
    ...
    negativas_ordenado = {}
    negativas_sort = sorted(negativas.items(), key=operator.itemgetter(1), reverse=True)
    ...
    muy_negativo_sort = sorted(muy_negativo.items(), key=operator.itemgetter(1), reverse=True)
