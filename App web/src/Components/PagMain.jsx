...
import graficos_imagen from "../images/pexels-lukas-590037.jpg";
import alfabeticamente_imagen from "../images/pexels-pixabay-434337.jpg";
import ok_imagen from "../images/pexels-andrea-piacquadio-3767418.jpg";
import bad_imagen from "../images/pexels-cottonbro-46296261.jpg";
import miner_imagen from "../images/clipart4755686.png";
import machine_imagen from "../images/Chip iconos vectoriales gratuitos diseñados por Freepik.png";
import sentiment_imagen from "../images/ambalina-sentiment-analysis-header.jpg";
  ...
  return (
    <Fragment>
        ...
        <div className="row d-flex justify-content-around">
          ...
          <div className="col">
            <h3>Análisis de sentimiento</h3>
              <img src={sentiment_imagen} width="239" height="159" alt="sentiment"/>
            <p>
      ...
      <div className="container mt-3 bg-light">
        <div className="row">
          <div className="col">
              <img src={alfabeticamente_imagen} width="500" height="331" alt="alfabeticamente" />
          </div>
          <div className="col">
            <h3>
